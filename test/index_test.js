...
describe('Client', () => {
  ...
  describe('constructor', () => {
    ...
    it('should have default port set to `mainnet`\'s one', () => {
      new Client().port.should.equal(9902);
    });

    it('should set default to port `9902` if network is `mainnet`', () => {
      new Client({ network: 'mainnet' }).port.should.equal(9902);
    });

    it('should set default to port `19902` if network is `testnet`', () => {
      new Client({ network: 'testnet' }).port.should.equal(19902);
    });

    it('should set default to port `19902` if network is `regtest`', () => {
      new Client({ network: 'regtest' }).port.should.equal(19902);
    });
